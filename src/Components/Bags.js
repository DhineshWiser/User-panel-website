...
const bagbanner = "https://raw.githubusercontent.com/DhineshWiser/User-panel-website/refs/heads/main/src/assets/bag-panner.jpg"
...
function Bags() {
    ...
    const filterdata = data.filter(items => items.listingType == "bags")
    console.log(filterdata);

    return (
        <div>
            <img class="card-img" src={bagbanner} alt="Card image" height="645px" />
            <Container>
                <Row className='py-5'>
                    <h2>Bags..</h2>
                    <hr />
